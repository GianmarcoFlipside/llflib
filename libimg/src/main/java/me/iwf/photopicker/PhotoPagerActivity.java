...
public class PhotoPagerActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        pagerFragment= ImagePagerFragment.newInstance(paths,currentItem);
    ...
    @Override public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.delete) {
            ...
            if (pagerFragment.getPaths().size() <= 1) {
                ...
                // show confirm dialog
                new AlertDialog.Builder(this).setTitle(R.string.confirm_to_delete).setPositiveButton(R.string.yes,
    ...
    public void updateActionBarTitle() {
        actionBar.setTitle(getString(R.string.image_index, pagerFragment.getViewPager().getCurrentItem() + 1,
